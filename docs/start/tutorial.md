...
We'll be building a small, but feature-rich app that lets you keep track of your contacts. We expect it to take about 30m if you're following along, otherwise it's a quick read.
...
You should have a lovely "Hello World" running.

<img class="tutorial" loading="lazy" src="/docs-images/contacts/02.webp" />

If you change the text and save, the UI should immediately update.
...
Let's add some more interesting markup to this page that we'll bring to life throughout this tutorial.

👉 **Replace the root.tsx code with this**
